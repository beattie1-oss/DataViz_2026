...
base_plot <- base_plot +
  ...
  theme(panel.grid.minor = element_blank(),
        ...
        plot.subtitle = element_text(face = "plain", size = rel(1.3), color = "grey70"), #rel = relation to base font
...
base_plot <- base_plot + theme(
  ...
  axis.title.x = element_text(margin = margin(t = 10), hjust = 0), # t b r l top bottom left and right
